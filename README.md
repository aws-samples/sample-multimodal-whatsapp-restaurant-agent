...
- **Runtime logs.** Amazon CloudWatch Logs at `/aws/bedrock-agentcore/runtimes/<runtime-name>-DEFAULT` show the Strands Agents events, model turn-taking, and per-tool `[mcp]` traces for each of the three runtimes.
