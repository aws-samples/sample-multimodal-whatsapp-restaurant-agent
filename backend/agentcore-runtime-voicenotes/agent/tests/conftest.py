"""Shared fixtures - make the VoiceNotes agent modules importable under pytest
when invoked from the repo root or from the agent/ directory itself.
"""
...
# (`import ogg_codec`, `import handler`, etc.) work regardless of cwd.
...
# up (never below 100).
#
# Import-safe even where Hypothesis is not installed.
# ---------------------------------------------------------------------------
try:
