"""Pure SDP analysis for the WhatsApp Call Runtime WebRTC answerer (Task 15).

Promoted verbatim from the single-shot-ICE spike (Task 14); the spike keeps its
own copy so it runs standalone.
